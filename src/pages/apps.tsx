...
export default function Apps(): ReactNode {
  const iconStyle = (vars: Record<string, string>): CSSProperties =>
    vars as CSSProperties;

  return (
    <Layout
      title="Apps | Neurocylcq"
      description="Categorized app launcher for fast navigation."
    >
        ...
        <section className={styles.heroBanner}>
          <div className="container">
            ...
            <Heading as="h1" className={styles.heroTitle}>
              Categorized Quick Navigation
            </Heading>
            <p className={styles.heroSubtitle}>
              Choose an app card by category to jump directly to the target
              page.
            </p>
          </div>
        </section>
            ...
            <section className={styles.categorySection}>
              ...
              <div className={styles.cardGrid}>
                <Link
                  ...
                  style={iconStyle({
                    "--bg-icon-size": "4.5rem",
                    "--bg-icon-right": "-0.05rem",
                    "--bg-icon-top": "54%",
                  })}
                >
                  <strong>Machine Learning</strong>
                  <p>
                    Open the ML note space for models, training, and
                    experiments.
                  </p>
                </Link>
                <Link
                ...
                >
                  ...
                  <p>
                    Check note confidence labels: Draft, Reviewed, Archived.
                  </p>
                </Link>
              </div>
            </section>
            ...
            <section className={styles.categorySection}>
              ...
              <div className={styles.cardGrid}>
                ...
                <Link
                  ...
                  data-icon="🔖"
                  style={iconStyle({
                    "--bg-icon-size": "4.25rem",
                    "--bg-icon-right": "0.12rem",
                    "--bg-icon-top": "50%",
                  })}
                >
            ...
            <section className={styles.categorySection}>
              ...
              <div className={styles.cardGrid}>
                ...
                <Link
                  ...
                  data-icon="🛠️"
                  style={iconStyle({
                    "--bg-icon-size": "4.45rem",
                    "--bg-icon-right": "0.02rem",
                    "--bg-icon-top": "52%",
                    "--bg-icon-rotate": "-6deg",
                  })}
                >
